...
const skills = [
  // Skills from "Page 1 Stardust word.docx"
  {
    ...
    description:
      "If you're going into space, it's probably a good idea to at least know how to fly a ship. This course will teach you the basics, and when you're through, you'll be able to adequately pilot almost any ship. Don't expect to outwit more experienced pilots, however.",
  ...
  },
  {
    ...
    description:
      "This course will put you through much more realistic simulations, and even take you onto the field a few times. New techniques open up a wave of new possibilities for you as an aspiring pilot, and you fly confidently enough to go toe-to-toe with other pilots out there.",
  ...
  },
  {
    ...
    description:
      "You're in the real world now, and you can't settle for anything less than the best when it comes to being a pilot. You'll be put in the most realistic conditions, enough that you're convinced that these are real situations they're throwing at you. Come out of this alive and you'll quickly become a respected pilot.",
    credits: -2000000,
  ...
  },
  {
    ...
    description:
      "This course highlights the advanced techniques in handling a certain ship weapon type. You can select either kinetic, energy, blaster, or explosive, boosting that weapon type's effectiveness when you're in command of the ship they're attached to.",
    credits: -2000000,
  ...
  },
  {
    ...
    title: "Medical",
    description:
      "People with medical knowledge are few and far between, but they're always in high demand. Having a doctor on board can improve the quality of life tenfold. Better yet, why not train yourself to become one?",
    credits: -2000000,
    prerequisites: [],
    consequences: [],
  ...
  },
  {
    ...
    description:
      "Information technology is heavily embedded into everything, so it's valuable knowledge to have. Especially when piloting a ship, it certainly helps to know how it works under the hood. Computer science is almost an essential skill to have for anyone hoping to travel the stars",
    credits: -2000000,
    prerequisites: [],
    consequences: [],
    playerUpdates: [
  ...
  },
  {
    ...
    title: "Mechanics",
    description:
      "Having no mechanical knowledge on your ship can lead to a boatload of problems; it's a no-brainer to have one on board. That said, knowing how to fix things yourself can't hurt, and it helps keep your mechanic doing more important things than trying to fix your robotic leg.",
    credits: -2000000,
    prerequisites: [],
    consequences: [],
  ...
  },
  {
    ...
    title: "Nuclear",
    description:
      "Almost every ship nowadays is powered by nuclear technology, be it through fission, fusion, or even anti- matter. At least knowing the do's and don'ts of nuclear sciences may mean the difference between life and becoming atomized into oblivion.",
    credits: -2000000,
    prerequisites: [],
    consequences: [],
  ...
  },
  {
    ...
    title: "Industry",
    description:
      "All of this would not be possible if it were not for the industrious side of society. Everything from mining, refining, and processing is covered in this course. If you plan on sailing the stars to make profit off of them, then you're going to want to have this skill under your belt.",
    credits: -2000000,
    prerequisites: [],
    consequences: [],
  ...
  },
  {
    ...
    title: "Diplomacy",
    description:
      "As someone who's likely going to get into a lot of interactions with others, it's good to at least know how to handle situations into your favour. You'll become a great mediator and can convince most people you're right. After taking this course, you can hire up to 4 crew members hostile to your faction.",
    credits: -2000000,
    prerequisites: [],
    consequences: [
...

  {
    ...
    title: "Mind-Link",
    description:
      "Experimental tech developed at Triglav that requires an immense amount of knowledge, patience, and fortitude to get through. With this skill, you'll be able to link your mind to your ship. <b>Can assume 3 jobs instead of 2</b>",
    credits: -2000000,
    prerequisites: [
      "skill-medical",
      "skill-mechanics",
      "skill-nuclear",
      "skill-advanced-piloting",
  ...
  },
  {
    ...
    title: "Mercantile",
    description:
      "After all is said and done, you're going to want to be able to make profit, and lots of it. It's probably a good idea to have the know-how on how to barter and trade, since the whole product of industry is to not only build society but to acquire the means to do it even better.",
    credits: -2000000,
    prerequisites: [],
    consequences: [],
    playerUpdates: [
  ...
  },
  {
    ...
    description:
      "Go through the same training any soldier goes though: Basic. You're trained on the basics of using firearms, you're whipped into taking basic orders, taught basic tactics, and trained in basic physical courses. All the fun stuff that, while basic, still pushes you to your limits.",
    credits: -2000000,
    prerequisites: [],
    consequences: [],
    playerUpdates: [
  ...
  },
  {
    ...
    description:
      "Anything that involves taking somebody on in the melee is covered this course. Learn to use the kinetics of your body as well as the handling of close combat weapons. Coming out of this course, you will never be caught without a knife. Or a hammer, if that's your thing.",
    credits: -2000000,
    prerequisites: [],
    consequences: [],
    playerUpdates: [
  ...
  },
  {
    ...
    title: "Security",
    description:
      "It's boring, but it's a start. You're left to guard some unknown building for god-knows-what, but all is not lost. Lucky for you, you got to use your weapons more than once; turns out that whatever you were guarding was of value to some people. You likely only faced untrained combatants, though.",
    credits: -2000000,
    prerequisites: [],
    consequences: [],
  ...
  },
  {
    ...
    title: "Patrol",
    description:
      "Another entry-level position, but you get to move! You get to experience the fun of sniffing out undesirables and neutralizing them. Towards the end of the term, you're brought to more hostile patrols where fights break out more often.",
    credits: -2000000,
    prerequisites: [],
    consequences: [],
  ...
  },
  {
    ...
    description:
      "Learn how to use your weapons effectively. From this course, you will be able to skillfully use most of the firearms out there. Your accuracy and precision will be disciplined. You even get to learn a little bit of the ins and outs of how firearms work.",
  ...
  },
  {
    ...
    title: "Field Medic",
    description:
      "A skilled medic is in high demand for all of the violence that happens in the civilized galaxy. Half of your effectiveness will come from your skill of using the latest medical technology, and the other half from your knowledge of healing. All of which can be learned from this course.",
    credits: -2000000,
    prerequisites: [],
    consequences: [],
    playerUpdates: [
  ...
  },
  {
    ...
    title: "Hit",
    description:
      "Unwanted miscreants are lurking everywhere, and your organization aims to thwart them all. What better way to spend your term than eliminating them? You get to do this on your own, as well. The more targets you eliminate, the more skilled and creative you get at doing it.",
    credits: -2000000,
  ...
  },
  {
    ...
    title: "Recovery",
    description:
      "Not all combat is about taking lives. Sometimes, you have to save them. Here, you will experience the praise of rescuing high-value targets. VIPs, hostages, and even valuable assets will be your focus. Tense situations await; you will need to be precise and efficient.",
    credits: -2000000,
    prerequisites: ["skill-security", "skill-patrol"], // Assuming 'or' means either one
    consequences: [],
  ...
  },
  {
    ...
    description:
      "You're good with firearms, but you aren't exactly a pronounced sniper... until you take this course, Learning to be a sniper is tough, and the success rate is discouraging to many. Training is body-breaking, and you will be pushed. If you prevail, you will become one of the most stout shots in the galaxy.",
    credits: -2000000,
  ...
  },
  {
    ...
    description:
      "With hundreds of planets out there, it isn't just enough to learn what grass is safe to eat. Be prepared to learn the most complex methods that can keep you alive with minimal provisions in the wilderness, across dozens of types of terrains.",
    credits: -2000000,
    prerequisites: [],
    consequences: [],
    playerUpdates: [
  ...
  },
  {
    ...
    title: "Raid",
    description:
      "You'll be working in groups for this. Experiencing the pressure of enacting plans and working in a team is invaluable. If one of you messes up, you risk falling apart. The raids get tougher and much more high risk towards the end of the term.",
    credits: -2000000,
    prerequisites: ["skill-security", "skill-patrol"], // Assuming 'or' means either one
    consequences: [],
  ...
  },
  {
    ...
    title: "Infiltration",
    description:
      "Learning how to become undetected is a hard skill to master, but experience is a good teacher. At first, you'll be snatching low-profile things like ID cards or documents. Then, money caches. Weapon caches. Classified information. People.",
    credits: -2000000,
    prerequisites: ["skill-security", "skill-patrol"], // Assuming 'or' means either one
    consequences: [],
    playerUpdates: [
  ...
  },
  {
    ...
    title: "Demolition",
    description:
      "After this course, you will be able to solve every problem with an explosion of some sort. You will get to handle all kinds of heavy weaponry and explosive devices, and become good at using them.",
    credits: -2000000,
    prerequisites: ["skill-advanced-firearms"],
    consequences: [],
    playerUpdates: [
  ...
  },
  {
    ...
    description:
      "A vehicle can provide many tactical and logistical advantages in combat, so knowing how to operate the many kinds of vehicles out there is valuable. Buggies, walkers, tanks, power armour, and even mobile suits are covered in this course.",
    credits: -2000000,
    prerequisites: [],
    consequences: [],
    playerUpdates: [
  ...
  },
  {
    ...
    title: "Assault",
    description:
      "Time to jump into the big fights. Experience the shell shocking action of the battlefield. Feel the ash and blood for yourself; you are but a grunt. A disposable, but no less necessary. Nothing whips a person into shape more than the heat of fire and smell of copper in the air.",
    credits: -2000000,
  ...
  },
  {
    ...
    title: "Guerilla",
    description:
      "It's often very illogical to take on a well-equipped base, which is why they're sending you to whittle it down bit by bit. You'll have to learn how to expend minimal resources to terrorize theirs. One mistake could end your life... or worse.",
    credits: -2000000,
  ...
  },
  {
    ...
    title: "Weaponsmith",
    description:
      "Weapons are everywhere, so it's a given to learn how they work in detail. Small arms, heavy weapons and even close-combat weapons are learned. You'll be able to do much more than just clean your guns; you'll be able to make them to your liking.",
    credits: -2000000,
    prerequisites: ["skill-advanced-firearms"],
    consequences: [],
    playerUpdates: [
  ...
  },
  {
    ...
    description:
      "You might be good at handling vehicles, but these mechanical monstrosities are made to take a beating. You'll learn more than just changing tires; from now on, you'll be praised for always bringing welding equipment.",
    credits: -2000000,
  ...
  },
  {
    ...
    title: "Leadership",
    description:
      "You've made promising progress, so you've been chosen to lead your own squad. This is the test of tests; will you be the end of your squad mates? Or will you promise them glory? Do this well, and you'll have a fearsome reputation.",
    credits: -2000000,
  ...
  },
  {
    ...
    title: "Defence",
    description:
      "This is like a security job, except you're trying to stop a full out assault. Provisions and manpower will be scarce in this remote location, but the enemy will crash into you wave after wave.",
    credits: -2000000,
...
const titles = [
  {
    ...
    description:
      "One or more of your crew will betray you at some point while you are adventuring the stars. You best hope you have good security personnel... unless they're the traitors. ",
  },
  {
    id: "title-whisperer",
    title: "The Whisperer",
  ...
  // Titles from "Page 1 Stardust word.docx"
  {
    ...
    description:
      "You never saw the reason to upgrade. What you have is perfect- ly fine, and you don't need anything fancier to accomplish what you do.",
    prerequisites: [],
    consequences: [],
  },
  {
  ...
  },
  {
    ...
    subDescription:
      "All ship shields permanently lose 2 points, to a minmum of 1. Shields cannot exceed 23/25. +All ship weapons permanently gain 1 point of damage per volley.",
    description:
      "Something's wrong with the shields of your ships, but no matter what you do, it can't be fixed. However, your weapons seem improved.",
    playerUpdates: [
      { attribute: "ship-weapon-damage", action: "add", value: 1 },
      {
        attribute: "ship-shield-strength",
        action: "subtract",
        value: 2,
        min: 1,
      },
...
const startPos = [
  ...
  },
  {
    ...
    allegiance: "Federation",
    description:
      "Laporte is less of a trade hub and more of a cargo gathering of freighters ferrying goods to and from New Terra. It has one station orbiting the single civilized planet, and is open to the public for trade. With all of the mass of products available, prices are fairly desirable, here.",
  },
  {
    cityName: "Dellsin",
    cityType: "other",
    allegiance: "Federation",
    description:
      "Dellsin is considered to be within the 'outer reaches' of the Federation, and like Arcadia, it sees a great mix of people coming and going. It is surrounded by several star systems in which planets are civilized with great urban cities.",
  },
  {
    cityName: "Wayward",
    cityType: "other",
  ...
  },
  {
    ...
    allegiance: "Federation",
    description:
      "As the Federation's top military staging system, Archer houses the largest legions of the Federation Navy Armada - the strongest military power in the civilized galaxy. It has access to many routes that give them the leverage to insert almost anywhere in the outer rims.",
  },
  ...
  },
  {
    ...
    allegiance: "The Talons",
    description:
      "The source of the Talon power is in their access to valuable, high-grade ore, and Zona is abundant in this, on top of being of a rare breed of star systems in which a planet is habitable. Using technology likely stolen from the Federation and possibly Pulsar Inc., the Talons are able to self-sustain their small sovereignty with surprising efficiency.",
  },
  ...
  },
  {
    ...
    allegiance: "Blackhawk Elite",
    description:
      "Seeking to take their righteousness further into dangerous territory, the Blackhawk Elites established Ragnarök, their second stronghold system. For decades, the Blackhawks defended Ragnarök fiercely, and through lots of blood, sweat, and tears, used Ragnarök's leverage to push far into pirate territory.",
  },
  {
    cityName: "Valhalla",
    cityType: "capital",
  ...
  // The Rebels
  {
    ...
    description:
      "The Federation has plenty of virtues, but some groups have failed to see them within the galactic nation. The rising threats from pirate groups such as the Luos Syndicate caused uprising in the outer Federation systems; where was the Navy when they were most needed? Detritus was the second system to claim separatism from the Federation, having been long fed up with the incompetency. And to make matters worse, the Federation simply dismissed the claim and labeled them as a 'pirate group', along with the Exodus system. Being left to fend for themselves, they've held out against bandits and pirates using guerilla tactics and make-shift hardware.",
  },
  {
    cityName: "Exodus",
    cityType: "capital",
  ...
  },
  {
    ...
    allegiance: "No Man's Land",
    description:
      "CYOA Event System: Contract: 'This Land', 'Mining King Steve'.",
  },
  {
    cityName: "Fordelia",
    cityType: "other",
  ...
  },
  {
    ...
    allegiance: "Independent",
    description:
      "Very similar to Pulsar Inc., Beatrice Research and Development started off as a pursuit for exploration, terraforming and research. Many of the accessible systems in the civilized galaxy are thanks to the technology developed by Beatrice, and they have since established their own few systems as a base of operations. Bastion is fitted with some of the most advanced technology ever built by humanity, and with an endless amount of stars within human reach, Beatrice continues to lead the charge into the unknown universe.",
  },
  {
    cityName: "Synchordia",
    cityType: "capital",
...
function addTitlesToSection(titlesArray, sectionID) {
  ...
  if (!Array.isArray(titlesArray)) {
    console.error(
      `Global variable "${titlesArray}" is not an array or does not exist.`
    );
    return;
  }
  ...
  titlesArray.forEach((item) => {
    ...
    imgElement.src =
      item.imageSrc ||
      "https://placehold.co/100x100/eeeeee/ffffff?text=NoImage";
    ...
    if (item.credits !== undefined) {
      // For older 'credits' attribute
      const creditsP = document.createElement("p");
      creditsP.innerHTML = `Bonus Credits: ${formatterIntl.format(
        item.credits
      )}`;
